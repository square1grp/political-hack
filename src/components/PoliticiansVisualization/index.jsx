 ...
 */
export default class PoliticiansVisualization extends React.Component {
  constructor(props) {
    super(props)
  ...
  getVisData(visType) {
    ...
    switch (visType) {
      case 'bar':
        return this.parseRawDataToBarData(visData)

      case 'line':
        return this.parseRawDataToLineData(visData)

      case 'scatter':
        return this.parseRawDataToScatterData(visData)

      case 'graph':
      default:
        return this.parseRawDataToGraphData(visData)
    }
  }
